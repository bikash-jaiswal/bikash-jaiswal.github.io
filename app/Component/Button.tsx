...
const Button: React.FC<ButtonProps> = ({
  ...
  // Base classes
  const baseClasses = 'inline-flex items-center justify-center font-medium rounded-lg transition-all duration-300 relative overflow-hidden focus-ring';
  ...
  const variantClasses = {
    ...
    outline: 'border border-violet-600 text-violet-400 hover:bg-violet-600/10 hover:text-white hover:border-violet-400',
