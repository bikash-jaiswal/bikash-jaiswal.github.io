  ...
  return (
    <div
      className={`p-4 rounded-lg shadow-md mt-4" ${
        isGrowthPlan ? "bg-gray-800 border-2 border-green-500" : ""
      }`}
    >
      <div className="">
        <h3 className="text-lg md:text-2xl font-semibold mb-2 text-green-600">
          {title}
        </h3>
        <p className="text-sm md:text-base text-gray-600 mb-2">
          {hours} hours per month
        </p>
        <p className="text-green-600 font-semibold text-sm md:text-base mb-4">
          {price} per month
        </p>
    ...
    <div>
      <div className="py-4 text-center">
        ...
        <p className="mb-4 p-4">
          ...
          your wealth while mastering your coding craft.
        </p>
      </div>

      <div className="mx-auto my-8 p-4 md:p-8 rounded ">
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4 text-text-xl md:text-2xl font-bold mb-4 text-center">
            Monthly Plans
          </h2>
